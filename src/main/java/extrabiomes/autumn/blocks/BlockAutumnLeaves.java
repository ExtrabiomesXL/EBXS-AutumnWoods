...
public class BlockAutumnLeaves extends BlockLeavesBase implements IShearable
{
    ...
    {
        textures[0] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesbrownautumnfancy");
        textures[1] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesbrownautumnfast");
        textures[2] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesorangeautumnfancy");
        textures[3] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesorangeautumnfast");
        textures[4] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesredautumnfancy");
        textures[5] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesredautumnfast");
        textures[6] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesyellowautumnfancy");
        textures[7] = iconRegister.registerIcon(Version.TEXTURE_PATH + "leavesyellowautumnfast");
        textures[8] = iconRegister.registerIcon(Version.TEXTURE_PATH + "better_leavesbrownautumn");
        textures[9] = iconRegister.registerIcon(Version.TEXTURE_PATH + "better_leavesorangeautumn");
        textures[10] = iconRegister.registerIcon(Version.TEXTURE_PATH + "better_leavesredautumn");
        textures[11] = iconRegister.registerIcon(Version.TEXTURE_PATH + "better_leavesyellowautumn");
    }
